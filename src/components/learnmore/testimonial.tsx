        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-black space-y-8 content">
            ...
            <p className="text-lg sm:text-xl text-gray-700 max-w-xl">
              It connects fiat, cryptocurrency, and digital assets to all and
              removes any middleman or centralized financial institution, thus
              providing much faster and secured transactions with very low fees.
            </p>
          ...
          <div className="relative flex justify-center">
            <div className="w-[350px] sm:w-[400px] lg:w-[500px] h-[350px] sm:h-[400px] lg:h-[500px] mx-auto rounded-full flex items-center justify-center kaichain-logo group">
              <div className="w-full h-full">
                <img
                  src="/shapes/shape-1.webp?height=450&width=450"
                  alt="Kaichain logo"
